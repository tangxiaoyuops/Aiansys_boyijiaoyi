...
5.空方锚定形态 + 放量大跌恐慌盘：
   ...
   - 操作建议：考虑建仓或者适当加仓
6. 连续下跌，跟随的大阴线跌破前低点，重要均线，导致恐慌盘放量，散户被洗出去：
   - 特征：连续下跌，跟随的大阴线跌破前低点，重要均线，导致恐慌盘放量，散户被洗出去
   - 识别要点：前面有连续下跌，跟随的大阴线跌破前低点或重要均线，导致恐慌盘放量，散户被洗出去
   - 操作建议：考虑建仓或者适当加仓
【买入规则（必须严格遵守）】
...
{{
    "buy_signals": [
        {{
            "date": "日期字符串",
            "price": 价格,
            "type": "恐慌点类型（stage5_panic/stage1_panic/washout_panic/uptrend_panic）",
