    ...
    <div class="form-section">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="80px">
        ...
        <el-form-item label="严重程度" prop="severity">
          <el-select v-model="form.severity" placeholder="请选择问题严重程度">
...
import { submitIssue, type IssueRequest } from '../api/feedback';
...
const rules: FormRules = {
  ...
  severity: [
    { required: true, message: '请选择问题严重程度', trigger: 'change' }
  ]
};
...
const handleSubmit = async () => {
  ...
  try {
    ...
    loading.value = true;
    const result = await submitIssue(form);
